...
VIDEO_PRESETS: list[dict[str, Any]] = [
    ...
    _video(
        ...
        "Для работы, а не для пака: переводит видео в MP4 без единой потери — "
        "кадры совпадают с исходными. Файл выйдет в разы больше, зато его "
        "можно резать и пересохранять сколько угодно.",
        codec="h264",
